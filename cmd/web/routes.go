...
func (srv *server) routes() http.Handler {
	...
	mux.HandleFunc("GET /posts/update/{slug}", srv.makeHandler(srv.handlePostUpdateGet()))
	mux.HandleFunc("POST /posts/update/{id}", srv.makeHandler(srv.handlePostUpdatePost()))
